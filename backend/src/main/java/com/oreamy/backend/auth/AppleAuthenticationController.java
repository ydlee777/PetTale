...
public class AppleAuthenticationController {
    ...
    private final OreamySessionIssuer sessions;

    public AppleAuthenticationController(AppleIdentityVerifier verifier, ServiceUserService users, OreamySessionIssuer sessions) {
