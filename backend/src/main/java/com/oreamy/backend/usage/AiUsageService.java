...
import com.oreamy.backend.access.ServiceAccess;
import com.oreamy.backend.access.ServiceAccessPolicy;
...
public class AiUsageService {
    ...
    public AiUsageService(ServiceUserRepository users, AiUsageRepository usages, Clock clock,
            ...
            @Value("${oreamy.ai.reservation-timeout}") Duration reservationTimeout) {
