...
import com.pettale.backend.usage.AiProviderMetadata;
import com.pettale.backend.usage.AiQuotaExceeded;
...
@SpringBootTest(properties = {
        "spring.datasource.url=${PETTALE_TEST_DB_URL:jdbc:h2:mem:service-access;MODE=PostgreSQL;DB_CLOSE_DELAY=-1}",
        ...
        "pettale.ai.premium-monthly-request-limit=5"
})
class ServiceAccessIntegrationTests {
    ...
    @Test void existingUserStartsNullAndFirstSuccessActivatesExactlyThirtyDays() {
    ...
    @Test void failedFirstRequestDoesNotActivateAndNextSuccessStillCan() {
        ...
        service.succeed(succeeded.getId(), metadata());
    ...
    @Test void statusEndpointUsesJwtOwnerAndAuthoritativeUsageCount() throws Exception {
        ...
        assertThat(response.getContentAsString()).contains(
                "\"plan\":\"PREMIUM_TRIAL\"", "\"trialEligible\":true",
    ...
    @Test void concurrentFirstSuccessIsSerializedByPostgresUserLock() throws Exception {
