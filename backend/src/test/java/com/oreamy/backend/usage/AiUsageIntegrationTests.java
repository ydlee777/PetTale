...
import com.oreamy.backend.ai.AiGatewayService;
...
@SpringBootTest(properties = {
        "spring.datasource.url=${OREAMY_TEST_DB_URL:jdbc:h2:mem:ai-usage;MODE=PostgreSQL;DB_CLOSE_DELAY=-1}",
        ...
        "oreamy.ai.premium-monthly-request-limit=2"
})
