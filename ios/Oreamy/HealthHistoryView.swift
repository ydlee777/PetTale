...
struct HealthHistoryView: View {
    ...
    var body: some View {
#if DEBUG
        if (ProcessInfo.processInfo.arguments.contains("-oreamyHealthDetail")
            || ProcessInfo.processInfo.environment["OREAMY_HEALTH_DETAIL"] == "1"),
    ...
    private var emptyState: some View {
        VStack(spacing: 16) {
            ...
            Text("Mention health-related moments in your daily recording and Oreamy will keep them here.")
                .foregroundStyle(.secondary)
                .multilineTextAlignment(.center)
