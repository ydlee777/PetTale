...
struct BackendEventExtractionService: EventExtractionService {
    ...
    func extract(
        ...
        request.httpBody = try JSONEncoder.oreamyExtraction.encode(RequestBody(
        ...
        do {
            let result = try JSONDecoder.oreamyExtraction.decode(EventExtractionResult.self, from: data)
...
private extension JSONEncoder {
    static var oreamyExtraction: JSONEncoder {
...
private extension JSONDecoder {
    static var oreamyExtraction: JSONDecoder {
